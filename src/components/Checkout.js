...
class Checkout extends React.Component {
  ...
  deleteAddress = async (addressId) => {
    ...
    if (this.validateResponse(errored, response, "delete the current address")) {
      if (response) {
  ...
  async componentDidMount() {
    if(localStorage.getItem("token") !== null){
      ...
      this.setState({
        products: await(await fetch(`${url}/products`)).json(),
        addresses: await(await fetch(`${url}/user/addresses`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + localStorage.getItem("token"),
      ...
      <>
        ...
        <div className="checkout-container">
          <Row>
            ...
            <Col xs={{order: 2, span: 24}} sm={{ order: 2, span: 24 }} md={{order: 1, span: 18}}>
                            ...
                            <div className="address">
                              <Radio.Button value={index}>
                                <div className="address-box">
                                  ...
                                  <Button
                                    type="primary"
                                    onClick={(e) => {this.deleteAddress(address._id)}}
                                  >
                                    Delete
                                  </Button>
                                </div>
            ...
            {/* Display the cart */}
            <Col xs={{order: 1, span: 24}} sm={{ order: 1, span: 24 }} md={{order: 2, span: 6}} className="checkout-cart" >
              <div>
